        ...
        <div class="box box-solid box-primary" style="margin-top:10px">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    ...
                    {!!Form::text('placa', $placa, array('class' => 'form-control placa', 'placeholder' => 'Digite a placa AAAA-0000', 'data-inputmask' => "'alias': 'placa'", 'data-mask' => ''));!!}
                </div>
            </div>
        </div>
    </div>
...
@endsection
@push('scripts')
<script src="{{asset('assets/routes/js/transportadora/updatetransportadora.js') }}"></script>
@endpush
