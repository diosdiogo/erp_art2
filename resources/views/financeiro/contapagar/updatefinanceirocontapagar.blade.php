                    ...
                    @if($idsituacao != 2)
                        <div class="col-xs-10">
                            <div class="info-box bg-red">
                                ...
                                <span class="info-box-text"><b>SALDO A PAGAR</b></span>
                    ...
                    @else
                        <div class="col-xs-10">
                            <div class="info-box bg-green">
                                ...
                                <div class="info-box-content">
                                <span class="info-box-text"><b>SALDO PAGO</b></span><BR>
                                <div class="progress">
                                    <div class="progress-bar" style="width: 100%"></div>
                                </div>
                                </div>
...
@push('scripts')
<script>
    $.namespace("updatefinanceirocontapagar", function(){
        var publico = {};
        ...
        gridElementoParcela.DataTable( {
                ...
                "ajax": {
                    "url": "/financeirocontapagar/obtercontapagaritens",
                    "dataSrc": ""
                },
                "columnDefs": [ {
                        "targets": -1,
    ...
    $(function(){
        $.namespace("updatefinanceirocontapagar").init();
    });
</script>
@endpush